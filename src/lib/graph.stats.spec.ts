...
// Construct a tiny dataset with known durations/resources
...
const events: EventLogEvent[] = [
  // Case A: 10 min A->B (r1), then terminal
  { caseId: 'A', activity: 'A', timestamp: t(0), resource: 'r1' },
  { caseId: 'A', activity: 'B', timestamp: t(10), resource: 'r1' },

  // Case B: 20 min A->B (r2)
  { caseId: 'B', activity: 'A', timestamp: t(0), resource: 'r2' },
  { caseId: 'B', activity: 'B', timestamp: t(20), resource: 'r2' },

  // Case C: 30 min A->B (r1)
  { caseId: 'C', activity: 'A', timestamp: t(0), resource: 'r1' },
  { caseId: 'C', activity: 'B', timestamp: t(30), resource: 'r1' },
];
...
describe('graph stats enrichment', () => {
  ...
  it('tracks unique resources on edges', () => {
